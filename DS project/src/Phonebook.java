...
public class Phonebook {
    ...
    public void addContact(Contact contact) {
        if (!UniqueContact(contact)) {
            System.out
                    .println("a contact with the same name or phone number already exists, Contact can not be added\n");
            return;
        }
    ...
    public boolean UniqueContact(Contact newContact) {
        ...
        while (existing != null) {
            if (existing.getName().equalsIgnoreCase(newContact.getName())
                    || existing.getPhoneNumber().equals(newContact.getPhoneNumber())) {
                return false;
            }
    ...
    public void searchContactsByCriteria(String criteria) {
        ...
        while (contact != null) {
            ...
            if (contact.getEmail().equalsIgnoreCase(criteria) || contact.getAddress().equalsIgnoreCase(criteria)
    ...
    public boolean eventHasConflict(Event newEvent) {
        ...
        while (event != null) {
            ...
            if (event.getDate().equals(newEvent.getDate())
                    && (event.getContactName().equals(newEvent.getContactName()))) {
                return true;
            }
